  ...
  <div class="swiper-container" id="top">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <div class="slide-inner" style="background-image:url(/resources/image/sleep.jpg)">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
                  <h2>우리의 <em>집 </em> 속으로<br>누군가<em>들어왔다.</em></h2>
      ...
      <div class="swiper-slide">
        <div class="slide-inner" style="background-image:url(/resources/image/elemental.jpg)">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
      ...
      <div class="swiper-slide">
        <div class="slide-inner" style="background-image:url(/resources/image/oppenheimer.jpg)">
          <div class="container">
            <div class="row">
              <div class="col-lg-8">
                <div class="header-text">
